...
const BOT_TOKEN = "5723710010:AAGbYeM2pDXbxf5qo5-y72Ozu4gG1T6oVWA"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "s1h2u3a4i5b6"; // Insert a powerful secret text.
const BOT_OWNER = 1958355347; // Insert your telegram account id.
const BOT_CHANNEL = -1001911169401; // Insert your telegram channel id which the bot is admin in.
